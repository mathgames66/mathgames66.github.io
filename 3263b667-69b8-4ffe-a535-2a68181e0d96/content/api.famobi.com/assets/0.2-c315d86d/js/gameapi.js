...
fg_api.prototype.trackingModule = function() {
	...
	function module() {
		...
		// Not proud of the following code because it's pretty hacky
		if(window.famobi_gameID === "garden-bloom" && self.config.aid === "A1000-1") {
			this.famobi_gameIDs.mapping["garden-bloom"] = "garden-bloom-payment";
		}
