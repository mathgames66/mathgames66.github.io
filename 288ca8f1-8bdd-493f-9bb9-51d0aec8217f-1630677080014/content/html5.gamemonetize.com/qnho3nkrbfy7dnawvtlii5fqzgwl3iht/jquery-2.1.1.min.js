    ...
    d.acceptData = function(e) {
        ...
        remove: function(e, t) {
            ...
            if (void 0 === t) this.cache[o] = {};
                ...
                d.isArray(t) ? r = t.concat(t.map(d.camelCase)) : (i = d.camelCase(t), r = t in s ? [t, i] : (r = i) in s ? [r] : r.match(A) || []), n = r.length;
                for (; n--;) delete s[r[n]]
            }
        },
        hasData: function(e) {
    ...
    var Fe, Pe, Me = /^(?:toggle|show|hide)$/,
        ...
        $e = [function(e, t, n) {
            ...
            for (r in n.queue || (null == (a = d._queueHooks(e, "fx")).unqueued && (a.unqueued = 0, u = a.empty.fire, a.empty.fire = function() {
                ...
                })), 1 === e.nodeType && ("height" in t || "width" in t) && (n.overflow = [p.overflow, p.overflowX, p.overflowY], "inline" === ("none" === (l = d.css(e, "display")) ? F.get(e, "olddisplay") || ve(e.nodeName) : l) && "none" === d.css(e, "float") && (p.display = "inline-block")), n.overflow && (p.overflow = "hidden", c.always(function() {
