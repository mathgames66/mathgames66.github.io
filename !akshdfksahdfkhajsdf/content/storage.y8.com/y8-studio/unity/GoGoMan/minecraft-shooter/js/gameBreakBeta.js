...
function noRewardAdsAvailable()
{
    ...
    myGameInstance.SendMessage('SDKPlatforms', 'NoRewardedAdsTryLater');
}

function cancelReward()
{
    console.log("cancelReward")
    myGameInstance.SendMessage('SDKPlatforms', 'rewardAdsCanceled');
}

function gainReward()
{
    console.log("gainReward")
    myGameInstance.SendMessage('SDKPlatforms', 'rewardAdsCompleted');
}

function passBeforeAdData()
{
    myGameInstance.SendMessage('SDKPlatforms', 'pauseGame');
}

function adBreakDoneData()
{
    myGameInstance.SendMessage('SDKPlatforms', 'resumeGame');
}
