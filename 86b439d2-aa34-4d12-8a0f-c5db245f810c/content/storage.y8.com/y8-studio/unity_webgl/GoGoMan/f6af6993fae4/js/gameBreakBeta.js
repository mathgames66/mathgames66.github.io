...
function noRewardAdsAvailable()
{
    ...
    myGameInstance.SendMessage('SDKPlatform', 'NoRewardedAdsTryLater');
}

function cancelReward()
{
    console.log("cancelReward")
    myGameInstance.SendMessage('SDKPlatform', 'rewardAdsCanceled');
}

function gainReward()
{
    console.log("gainReward")
    myGameInstance.SendMessage('SDKPlatform', 'rewardAdsCompleted');
}

function passBeforeAdData()
{
    myGameInstance.SendMessage('SDKPlatform', 'pauseGame');
}

function adBreakDoneData()
{
    myGameInstance.SendMessage('SDKPlatform', 'resumeGame');
}
